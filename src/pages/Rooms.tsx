...
const Rooms = () => {
  ...
  const generateBill = async () => {
    ...
    try {
      ...
      const extraBedCharges = guest.extraBeds ? guest.extraBeds.reduce((sum: number, bed: any) => sum + bed.charge, 0) : 0
      
      // Room rent should be totalAmount - extraBedCharges (as shown in checkout form)
      const roomRent = guest.totalAmount - extraBedCharges
      const totalRoomCharges = guest.totalAmount
